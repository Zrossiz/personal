    ...
    <Layout>
      <>
        ...
        <p>
          ...
          лет. <br /> За это время я разработал более 5 коммерческих проектов, включая веб-приложения на
          JavaScript и Golang. В настоящий момент я активно изучаю Golang и открыт к предложениям по
          Go разработке. Помимо работы с базами данных (MySQL, PostgreSQL, MongoDB), я обладаю
          опытом работы с системами управления версиями (Git) и облачными технологиями (S3).
        </p>
