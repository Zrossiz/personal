    ...
    <Layout>
      <>
        ...
        <p>
          ...
          использованием Go, PostgreSQL, Redis и MinIO (S3).
        </p>
        <h2 id="-">Мотивация проекта</h2>
        <ul>
          <li>Практика использования Go и GORM для создания микросервисного приложения.</li>
        ...
        <h3 id="-s3-go">Работа с S3 через Go</h3>
        <ul>
          <li>
            Использовать <strong>MinIO Go SDK</strong> для работы с объектным хранилищем:
            <ul>
              <li>
                <a href="https://github.com/minio/minio-go/v7">MinIO Go SDK</a>.
              </li>
            </ul>
          </li>
        </ul>
