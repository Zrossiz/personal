    ...
    <Layout>
      <>
        ...
        <ul>
          ...
          <li>
            Изучение работы с базой данных <strong>PostgreSQL</strong> и написание сложных
            SQL-запросов без ORM (без Gorm).
          </li>
          <li>
            Использование <strong>Redis</strong> для кэширования и повышения производительности.
          </li>
          <li>
            Реализация многоуровневой авторизации с использованием <strong>JWT</strong> токенов
            (Access и Refresh).
          </li>
          <li>
        ...
        <h3>Бэкенд</h3>
        <p>
          Приложение на <strong>Go</strong>, реализующее REST API для управления пользователями,
        ...
        <ul>
          ...
          <li>
            Написание сложных <strong>SQL-запросов</strong> для анализа предпочтений пользователей
            (например, <code>JOIN</code>, <code>GROUP BY</code>).
          </li>
        </ul>
        ...
        <ol>
          <li>
            <strong>Настройка БД</strong> — интеграция PostgreSQL и Redis с приложением на Go.
          </li>
          <li>
