    ...
    <Layout>
      <>
        ...
        <ul>
          ...
          <li>
            Использование <strong>JS</strong> для создания надежного и высокопроизводительного
            сервиса.
          </li>
          <li>
          ...
          <li>Безопасная аутентификация и авторизация с помощью JWT.</li>
          <li>
        ...
        <ul>
          <li>
            <strong>API-сервис (NestJS)</strong> - взаимодействие с пользователями и управление
            бронированиями.
          </li>
          <li>
          ...
          <li>
            <strong>Воркеры (ExpressJS)</strong> - обработка уведомлений.
          </li>
          <li>
...
export default JSBookingSystemPage;
