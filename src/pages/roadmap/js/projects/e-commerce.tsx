          ...
          <>
            ...
            <ul>
              <li>
                ...
                <ol>
                  <li>Backend — основное приложение с бизнес-логикой. NestJs</li>
                  <li>Frontend — клиентская часть. NextJs</li>
                  <li>Database — реляционная база данных для хранения информации. PostgreSQL</li>
                  <li>Tg bot app — Telegram-бот для уведомлений. ExpressJS</li>
                </ol>
              </li>
            </ul>
...
export default JsECommercePage;