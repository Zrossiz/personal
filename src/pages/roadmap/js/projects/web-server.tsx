    ...
    <Layout>
      ...
      <h1>Веб-сервер для управления заметками</h1>
        ...
        <p>
          ...
          веб-серверами, роутингом и CRUD-операциями на Js с использованием стандартной библиотеки.
        ...
        <ul>
          ...
          <li>
            <code>PUT /notes/&#123;id&#125;</code> — Обновляет заметку с указанным идентификатором.
        ...
        <ul>
          <li>
            Инициализировать проект с помощью Node.js (<code>npm init</code>).
          </li>
          <li>
            Создать файл <code>main.js</code> для основной логики веб-сервера.
          </li>
        ...
        <ul>
          <li>
            <strong>Язык программирования</strong>: Js.
          </li>
          <li>
            <strong>Стандартная библиотека</strong>:
            <ul>
              <li>
                <code>http</code> для работы с HTTP-запросами.
              </li>
            </ul>
          </li>
        </ul>
